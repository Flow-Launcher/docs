  ...
  searched = plugins
    ...
    .sort((a, b) => {
      switch (sorting) {
        ...
        case 'updatedAsc':
          return a.LatestReleaseDate && b.LatestReleaseDate ? a.LatestReleaseDate?.localeCompare(b.LatestReleaseDate) : 1000;
        case 'updatedDesc':
          return b.LatestReleaseDate && a.LatestReleaseDate ? b.LatestReleaseDate?.localeCompare(a.LatestReleaseDate) : 1000;
        case 'default':
